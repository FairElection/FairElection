#ifndef _spacesaving_replace_H
#define _spacesaving_replace_H
...
using namespace std;
class spacesaving_replace
{
    private:
        ssummary *ss;
        int M2;
    public:
        spacesaving_replace(int M2):M2(M2) {ss=new ssummary(M2); ss->clear();}
